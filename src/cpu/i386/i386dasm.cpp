...
static const I386_OPCODE i386_opcode_table1[256] =
{
	...
	// 0x70
	{"jo",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jno",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jb",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jae",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"je",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jne",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jbe",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"ja",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"js",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jns",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jp",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jnp",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jl",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jge",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jle",             0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jg",              0,              PARAM_REL8,         0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	// 0x80
	{"group80",         GROUP,          0,                  0,                  0               },
	{"group81",         GROUP,          0,                  0,                  0               },
	{"group80",         GROUP,          0,                  0,                  0               },
	...
	{"call",            ALWAYS64,       PARAM_ADDR,         0,                  0,              DASMFLAG_STEP_OVER | DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"wait",            0,              0,                  0,                  0               },
	...
	{"groupC0",         GROUP,          0,                  0,                  0               },
	{"groupC1",         GROUP,          0,                  0,                  0               },
	{"ret",             0,              PARAM_UI16,         0,                  0,              DASMFLAG_STEP_OUT | DASMFLAG_STOP },
	{"ret",             0,              0,                  0,                  0,              DASMFLAG_STEP_OUT | DASMFLAG_STOP },
	...
	{"leave",           0,              0,                  0,                  0               },
	{"retf",            0,              PARAM_UI16,         0,                  0,              DASMFLAG_STEP_OUT | DASMFLAG_STOP },
	{"retf",            0,              0,                  0,                  0,              DASMFLAG_STEP_OUT | DASMFLAG_STOP },
	...
	{"call",            0,              PARAM_REL,          0,                  0,              DASMFLAG_STEP_OVER | DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jmp",             0,              PARAM_REL,          0,                  0,              DASMFLAG_STOP | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
	{"jmp",             0,              PARAM_ADDR,         0,                  0,              DASMFLAG_STOP | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
	{"jmp",             0,              PARAM_REL8,         0,                  0,              DASMFLAG_STOP | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
...
static const I386_OPCODE i386_opcode_table2[256] =
{
	...
	// 0x80
	{"jo",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jno",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jb",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jae",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"je",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jne",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jbe",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"ja",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"js",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jns",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jp",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jnp",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jl",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jge",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jle",             0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	{"jg",              0,              PARAM_REL,          0,                  0,               DASMFLAG_OPERAND_IS_CODE_ADDRESS},
	// 0x90
...
static const I386_OPCODE groupFF_table[8] =
{
	...
	{"call",            ALWAYS64,       PARAM_RMPTR,        0,                  0,              DASMFLAG_STEP_OVER | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
	{"call    far ptr ",0,              PARAM_RM,           0,                  0,              DASMFLAG_STEP_OVER | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
	{"jmp",             ALWAYS64,       PARAM_RMPTR,        0,                  0,              DASMFLAG_STOP | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
	{"jmp     far ptr ",0,              PARAM_RM,           0,                  0,              DASMFLAG_STOP | DASMFLAG_OPERAND_IS_CODE_ADDRESS },
...
class i386Disassembler
{
public:
const uint8_t *opcode_ptr;
const uint8_t *opcode_ptr_base;
int address_size;
int operand_size;
int address_prefix;
int operand_prefix;
...
char hexstring_buffer[20];
char *hexstring(uint32_t value, int digits)
{
	hexstring_buffer[0] = '0';
	if (digits)
		sprintf(&hexstring_buffer[1], "%0*Xh", digits, value);
	else
		sprintf(&hexstring_buffer[1], "%Xh", value);
	return (hexstring_buffer[1] >= '0' && hexstring_buffer[1] <= '9') ? &hexstring_buffer[1] : &hexstring_buffer[0];
}

char hexstring64_buffer[40];

char *hexstring64(uint32_t lo, uint32_t hi)
{
	hexstring64_buffer[0] = '0';
	if (hi != 0)
		sprintf(&hexstring64_buffer[1], "%X%08Xh", hi, lo);
	else
		sprintf(&hexstring64_buffer[1], "%Xh", lo);
	return (hexstring64_buffer[1] >= '0' && hexstring64_buffer[1] <= '9') ? &hexstring64_buffer[1] : &hexstring64_buffer[0];
}
...
char shexstring_buffer[20];

char *shexstring(uint32_t value, int digits, bool always)
{
	if (value >= 0x80000000)
		sprintf(shexstring_buffer, "-%s", hexstring(-value, digits));
	else if (always)
		sprintf(shexstring_buffer, "+%s", hexstring(value, digits));
	else
		return hexstring(value, digits);
	return shexstring_buffer;
}

void handle_sib_byte(std::ostream &stream, uint8_t mod)
{
	uint32_t i32;
...
void handle_modrm(std::ostream &stream)
{
	int8_t disp8;
	int16_t disp16;
	int32_t disp32;
...
void handle_modrm(std::string &buffer)
{
...
void handle_param(std::ostream &stream, uint32_t param)
{
	uint8_t i8;
	uint16_t i16;
	uint32_t i32;
...
void handle_fpu(std::ostream &stream, uint8_t op1, uint8_t op2)
{
	switch (op1 & 0x7)
	{
		case 0:     // Group D8
...
void decode_opcode(std::ostream &stream, const I386_OPCODE *op, uint8_t op1)
{
	int i;
	uint8_t op2;
...
flags_t i386_dasm_one_ex(std::ostream &stream, uint64_t eip, const uint8_t *oprom, int mode)
{
	uint8_t op;
...
{
	i386Disassembler disassembler;
	return disassembler.i386_dasm_one_ex(stream, eip, oprom, mode);
}
